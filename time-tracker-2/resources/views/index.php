    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container-fluid time-entry">
        <div class="timepicker">
          ...
          <div uib-timepicker ng-model="vm.clockIn" hour-step="1" minute-step="1" show-meridian="true">
          </div>
        </div>
        <div class="timepicker">
          <span class="timepicker-title label label-primary">Clock Out</span>
          <div uib-timepicker ng-model="vm.clockOut" hour-step="1" minute-step="1" show-meridian="true">
          </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="well timeentry" ng-repeat="time in vm.timeentries">
          <div class="row">
            ...
            <div class="col-sm-4 time-numbers">
              ...
              <h2>
                <span class="label label-primary" ng-show="time.loggedTime.duration._data.hours > 0">{{time.loggedTime.duration._data.hours}} hour<span ng-show="time.loggedTime.duration._data.hours !== 1">s</span>
                </span>
              </h2>
              <h4>
                <span class="label label-default">{{time.loggedTime.duration._data.minutes}} minute<span ng-show="time.loggedTime.duration._data.minutes !== 1">s</span>
                </span>
              </h4>
            </div>
          </div>
          ...
          <div class="row edit-time-entry" ng-show="showEditDialog === true">
            ...
            <div class="time-entry">
              <div class="timepicker">
                <span class="timepicker-title label label-primary">Clock In</span><div uib-timepicker ng-model="time.start_time" hour-step="1" minute-step="1" show-meridian="true">
                </div>
              </div>
              <div class="timepicker">
      ...
      <div class="col-sm-4">
        <div class="well time-numbers">
          ...
          <h3><span class="label label-primary">{{vm.totalTime.hours}} hour<span ng-show="time.loggedTime.duration._data.hours !== 1">s</span></span></h3>
          <h3><span class="label label-primary">{{vm.totalTime.minutes}} minute<span ng-show="time.loggedTime.duration._data.minutes !== 1">s</span></span></h3>
        </div>
      </div>
    </div>
  </body>
